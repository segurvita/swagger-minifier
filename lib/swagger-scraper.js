 ...
 * @param {string} scrapType type of scrap. [delete, empty, deleteParent]
 * @param {string} outputFormat format of output. [string, object]
 */
const scrap = (inputSwagger,
  scrapTarget = 'example',
  scrapType = 'delete',
  outputFormat = 'string') => {
  // validate input
  ...
  switch (scrapType) {
    ...
    case 'empty':
      ...
      break;
    case 'deleteParent':
      deleteParentRecursion(objSwagger, scrapTarget);
      break;
    default:
  }
...
exports.deleteTarget = (
  inputSwagger, scrapTarget, outputFormat,
 ...
 * @param {string} outputFormat format of output. [string, object]
 */
exports.deleteParent = (
  inputSwagger, scrapTarget, outputFormat,
) => scrap(inputSwagger, scrapTarget, 'deleteParent', outputFormat);
